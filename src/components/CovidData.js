            ...
            <Container fluid style={{ backgroundColor: '#f8f8ff', padding: 0 }} className="App">
                ...
                <footer>
                    <Row className="App-footer">
                        <Col md={2} xs={5}>
                            Created by <a href="https://github.com/b18050/flattenthecurve" target="_blank">openhacks</a>
                            </Col>
                        <Col md={{span:1, offset:9}} xs={{span:3, offset:4}}>
                            <a href="https://github.com/pomber/covid19">source of data</a>
                        
                        </Col>
                        <Col md={{span:1, offset:15}} xs={{span:3, offset:6}}>
                            <a href="https://github.com/workaholic7/covid19visuals">Inspiration</a>
